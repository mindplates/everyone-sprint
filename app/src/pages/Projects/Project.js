...
import { Block, BlockRow, BlockTitle, BottomButtons, Label, Page, PageContent, PageTitle, Text, UserList } from '@/components';
...
export default connect(mapStateToProps, undefined)(withTranslation()(withRouter(Project)));
